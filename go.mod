...
require (
	buf.build/gen/go/ttm/messenger-protocol/grpc/go v1.6.2-20260717001030-75f9c5206727.1
	buf.build/gen/go/ttm/messenger-protocol/protocolbuffers/go v1.36.11-20260717001030-75f9c5206727.1
